set --local CONDITION 'not __fish_seen_argument --short r --long required-val --short o --long optional-val'
...
complete --command fish_opt --short-option L --long-option long-only --description 'Use only long option'
